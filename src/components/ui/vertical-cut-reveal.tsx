    ...
    return (
      <span
        ...
        className={cn(
          containerClassName,
          'hof-vertical-reveal',
          splitBy === 'lines' && 'hof-vertical-reveal--lines'
        )}
        onClick={onClick}
        {...props}
      >
        {wordObjects.map((wordObj, wordIndex, array) => {
          ...
          return (
            <span
              key={wordIndex}
              aria-hidden="true"
              className={cn('hof-vertical-reveal__word', wordLevelClassName)}
            >
              {wordObj.characters.map((char, charIndex) => (
                <span
                  key={charIndex}
                  className={cn('hof-vertical-reveal__char', elementLevelClassName)}
                >
                  <motion.span
                    ...
                    className="hof-vertical-reveal__motion"
                  >
                    {char}
                  </motion.span>
                </span>
